...
$('body').one('click', function() { $('input[type=text]').placeholder(); });
$('#detailsModal').one('mouseenter', function() { $('input[type=text]').placeholder(); });
$('#tools-details').one('click', function() { $('input[type=text]').placeholder(); });
